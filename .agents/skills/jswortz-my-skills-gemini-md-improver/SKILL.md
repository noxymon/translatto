...
description: Audits, evaluates, and improves GEMINI.md files across a codebase. Use when asked to check, update, or fix GEMINI.md files for optimal project context.
---
